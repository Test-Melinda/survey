export const data = {
    ...
    "SURVEY_INTRO": {
		...
		"LEGAL": {
			...
			"CONTACT": "Si vous avez d'autres questions au sujet de ce projet ou si vous avez une question relative à la recherche, vous pouvez contacter {{ contact.name }} (<a href=\"mailto:{{ contact.email }}\">{{ contact.email }}</a>).",

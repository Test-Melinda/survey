...
//		"SUBMIT_ERROR": "Sorry, an error occurred. Please click the button below if you want to retry the survey. Otherwise please <a href=\"{{ contactLink }}\">contact us</a>. Thank you.",
    ...
    "SURVEY_INTRO": {
		...
		"LEGAL": {
			...
			"INTRO": "Vous êtes invités à participer à une enquête de recherche, menée dans le cadre du projet MELINDA, en particulier par l'Université de Milano-Bicocca. Votre participation à cette étude est entièrement volontaire et anonyme. Il ne vous sera pas demandé d'indiquer votre nom.",
			"GDPR": "Les données collectées seront stockées sur des serveurs sécurisés situés dans l'UE et traitées conformément au RPGD.",
			"SCOPE": "Pour mieux comprendre les choix de mobilité des personnes, nous vous poserons quelques questions sur vos habitudes de voyage, vos préférences, votre conscience environnementale et, à des fins de classification statistique, quelques informations sociodémographiques de base (âge, sexe, éducation, profession, code postal et dimension familiale).  Votre adresse courriel, si vous nous la communiquez (ce n'est pas obligatoire), sera conservée séparément des réponses et utilisée uniquement pour vous communiquer les développements de notre projet. Les renseignements recueillis peuvent être utilisés par le personnel de recherche des partenaires du projet dans le strict respect des mesures de protection de l'identité personnelle. Les résultats agrégés de l'étude pourront être publiés et/ou présentés lors de réunions.",
			"CONTACT": "Si vous avez d'autres questions au sujet de ce projet ou si vous avez une question relative à la recherche, vous pouvez contacter Simone Caiello (<a href=\"mailto:{{ contactEmail }}\">{{ contactEmail }}</a>).",
			"PRIVACY_ACCEPTANCE": "<strong>En cochant la case Confidentialité ci-dessous</strong>, vous indiquez que vous avez lu et compris ce formulaire de consentement, que vous avez au moins 16 ans et que vous acceptez de participer à cette étude de recherche."
		},
		"PRIVACY": {
...
//		"ACCEPT": "Accept and start survey"
	...
	"SCORE_VIEWER": {
		...
		"LEVEL": {
			...
			"GOOD": "Bon",
			"AVERAGE": "Moyen",
			"LOW": "Vous pouvez faire mieux",
			"VERY_LOW": "C'est le bon moment pour commencer"
		},

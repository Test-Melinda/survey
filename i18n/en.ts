export const data = {
    ...
    "SURVEY_INTRO": {
		...
		"LEGAL": {
			...
			"CONTACT": "If you have any further questions about this project or if you have a research-related query, you may contact {{ contact.name }} at <a href=\"mailto:{{ contact.email }}\">{{ contact.email }}</a>.",

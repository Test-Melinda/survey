export const data = {
    ...
    "SURVEY_INTRO": {
		...
		"LEGAL": {
			...
			"CONTACT": "Per qualsiasi ulteriore informazione riguardo questo progetto o per qualsiasi domanda legata alla ricerca puoi contattare il dott. {{ contact.name }} all'indirizzo <a href=\"mailto:{{ contact.email }}\">{{ contact.email }}</a>.",

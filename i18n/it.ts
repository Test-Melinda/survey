export const data = {
	...
	"SCORE_VIEWER": {
		...
		"SOLUTIONS": {
			...
			"Q_ACTIVITY_MORE": "Questo è molto utile in maniera da migliorare la forma cardio-vascolare e muscolare, la salute delle ossa e ridurre il rischio di diverse malattie tra cui la depressione! Tramite pratiche di mobilità attiva puoi mirare a rispettare gli obiettivi dell'OMS, migliorando la tua salute (e allo stesso tempo la salute dell'ambiente circostante)."
		},
